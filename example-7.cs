...
public class LaserController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            nextFire = Time.time + fireRate; // Bekleme süresi belirleniyor
    ...
    void FireLaser()
    {
        ...
        // Lazer objesi ekrandan çıktıktan sonra yok edilecek
...
public class LaserMovement : MonoBehaviour
{
    ...
    void Update()
    {
        // Lazer her saniye bir birim yukarı doğru hareket eder
